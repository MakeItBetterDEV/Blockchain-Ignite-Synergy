...
export { MsgUpdateParams, MsgCreatePost, MsgUpdatePost, MsgDeletePost };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgUpdateParams({ value }: msgUpdateParamsParams): EncodeObject {
			try {
				return { typeUrl: "/projectbit.projectbit.v1.MsgUpdateParams", value: MsgUpdateParams.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreatePost({ value }: msgCreatePostParams): EncodeObject {
			try {
				return { typeUrl: "/projectbit.projectbit.v1.MsgCreatePost", value: MsgCreatePost.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdatePost({ value }: msgUpdatePostParams): EncodeObject {
			try {
				return { typeUrl: "/projectbit.projectbit.v1.MsgUpdatePost", value: MsgUpdatePost.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDeletePost({ value }: msgDeletePostParams): EncodeObject {
			try {
				return { typeUrl: "/projectbit.projectbit.v1.MsgDeletePost", value: MsgDeletePost.fromPartial( value ) }  
			} catch (e: any) {
...
const IgntModule = (test: IgniteClient) => {
	return {
		module: {
			ProjectbitProjectbitV_1: new SDKModule(test)
		},
		registry: msgTypes
  }
}
