...
import (
	_ "projectBit/x/projectbit/module"
	projectbitmoduletypes "projectBit/x/projectbit/types"
	"time"
...
var (
	moduleAccPerms = []*authmodulev1.ModuleAccountPermission{
		...
		{Account: projectbitmoduletypes.ModuleName},
	}
		...
		Modules: []*appv1alpha1.ModuleConfig{
			{
				...
				Config: appconfig.WrapAny(&runtimev1alpha1.Module{
					...
					BeginBlockers: []string{
						...
						// chain modules
						projectbitmoduletypes.ModuleName,
			...
			{
				Name:   projectbitmoduletypes.ModuleName,
				Config: appconfig.WrapAny(&projectbitmoduletypes.Module{}),
			},
			{
